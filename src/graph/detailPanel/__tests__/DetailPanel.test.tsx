...
describe("DetailPanel", () => {
  ...
  it("hides raw attributes in Beginner mode and reveals them, EXPANDED, in Expert mode (Story 18.7, spec §1f)", () => {
    const node = makeNode({ attributes: { "Relation Name": "orders" } })
    renderPanel(node)
    // Design review, spec §1f: "Beginner: ... raw attributes hidden."
    // (An earlier, differently-phrased reading of the spec briefly had
    // this rendering — collapsed — in Beginner too; §1f is the more
    // specific, later text on this exact question.)
